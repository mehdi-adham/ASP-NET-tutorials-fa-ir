...
شما در واقع به یک کانکشن استرینگ در فایل Web.config نیاز ندارید. اگر رشته اتصال ارائه نمی کنید، Entity Framework از یک رشته اتصال پیش فرض بر اساس کلاس کانتکست شما استفاده می کند.
